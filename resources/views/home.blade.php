            ...
            <div class="row">
                @foreach ($products as $product)
                    <div class="col-md-3 mx-2">
                        <div class="menu-entry card bg-transparent" style="border:solid 2px #A9865F">
                            <a href="#" class="img"
                                style="width:100%;background-image: url({{ asset('assets/images/' . $product->image) }});"></a>
                            <div class="text text-center pt-4">
                                <h3><a href="{{ route('product.view', $product->id) }}">{{ $product->name }}</a></h3>
                                <p>{{ substr($product->description, 0, 50) }}</p>
                                <p class="price"><span>{{ $product->price }}</span></p>
                                <p><a href="{{ route('product.view', $product->id) }}"
